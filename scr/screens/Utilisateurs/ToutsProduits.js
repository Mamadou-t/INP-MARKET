...
function ToutsProduits({navigation}){
            ...
            <View>
                ...
                <View style={{justifyContent:'space-between',flexDirection:'row',marginRight:hp(2)}} >
                  <View style={{flexDirection:'row'}}>
                          <Retour />
                          <Text style={{fontSize:hp(2.5),fontWeight:'bold',marginTop:hp(2)}}>Touts les produits</Text>
                  </View>

                  <View style={{flexDirection:'row',marginHorizontal:hp(2),marginTop:hp(2)}}>
                        <TouchableOpacity style={{paddingHorizontal:hp(2)}} onPress={()=>navigation.navigate('Rechercher_Produits',PRODUIT)}>
